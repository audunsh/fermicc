...
void flexmat6::report(){
    ...
    cout << "## vp:" << vp.n_rows << "/" << vp.max() << endl;
    cout << "## vq:" << vq.n_rows << "/" << vq.max() << endl;
    cout << "## vr:" << vr.n_rows << "/" << vr.max() << endl;
    cout << "## vs:" << vs.n_rows << "/" << vs.max() << endl;
    cout << "## vt:" << vt.n_rows << "/" << vt.max() << endl;
    cout << "## vu:" << vu.n_rows << "/" << vu.max() << endl;
    cout << "## vvals:" << vValues.n_rows << "/" << vValues.max() << endl;
    cout << "#################################" << endl;
}
...
void flexmat6::partition(field<vec> fBlocks){
    ...
    //not yet implemented
    uint nblocks = fBlocks.n_rows; //number of blocks
}
...
mat flexmat6::rows_dense(uvec urows){
    ...
    //2. set up M(rows.n_rows+1, longest row)
    //MCols.clear();
    ...
    mat M(urows.n_rows, blocksize);
    //mat M;
    //M.randn(urows.n_rows, blocksize);
    //cout << urows.n_rows << " " << blocksize << " " << n_cols << endl;
...
void flexmat6::set_amplitudes(vec Energy){
    ...
    //cout << nnz.n_rows << " " << vValues.n_rows << endl;
    vp = vp.elem(nnz);
    vq = vq.elem(nnz);
    vr = vr.elem(nnz);
    vs = vs.elem(nnz);
