...
{
    electrongas fgas;
    fgas.generate_state_list2(2.0,1.0, 2);

    //cout << "Energy per particle:" << fgas.eref(14)/14.0 << " (a.u)"  << endl;
    cout << "# Energy per particle:" << 2*fgas.eref(14)/14.0 << " (rydberg)"  << endl;
    cout <<setprecision(16) << "# Energy per particle:" << 2*fgas.eref(14)/14.0 << " (rydberg)"  << endl;
    ...
    /*
    for(int i=0; i<fgas.vEnergy.size(); ++i ){
        cout << fgas.vEnergy(i) << endl;
    }
